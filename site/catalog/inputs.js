  ...
  render() {
    return (
      <div>
        ...
        <div className="mb24">
          <div className="mr6 mb6 inline-block">
            <input className="input w240" placeholder="date" type="date" />
          </div>
          <div className="mr6 mb6 inline-block">
            <input className="input w240" placeholder="number" type="number" />
          </div>
          <div className="mr6 mb6 inline-block">
            <input className="input w240" placeholder="search" type="search" />
          </div>
          <div className="mr6 mb6 inline-block align-t">
            <input className="input w240" type="color" />
          </div>
          <div className="mr6 mb6 inline-block">
            <input
