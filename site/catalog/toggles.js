    ...
    <div className={toggleGroupClass}>
      <label className="toggle-container">
        <input
          ...
          type="radio"
        />
        <div className={toggleClass}>cow</div>
      </label>
      <label className="toggle-container">
        <input
          defaultChecked={true}
          ...
          type="radio"
        />
        <div className={toggleClass}>horse</div>
      </label>
      <label className="toggle-container">
        <input
          disabled={props.disabled}
          ...
          type="radio"
        />
        <div className={toggleClass}>pig</div>
      </label>
    </div>
  );
}
  ...
  render() {
    return (
      <div>
        ...
        <div className="mt24 mb12 txt-bold color-darken50 txt-uppercase txt-s">
          Disabled and light
        </div>
        <div className="bg-gray round px12 py12 mt12">
          {lightenColors.map(c => (
