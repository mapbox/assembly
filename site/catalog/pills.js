    ...
    return (
      <div>
        ...
        <div className="flex-parent mb18">
          ...
          <button className="btn btn--red btn--stroke btn--pill-stroke btn--pill-hc round is-active">
            Confirm
          </button>
          <button className="btn btn--red btn--pill-stroke btn--pill-hc round is-active">
            Confirm
          </button>
          <button className="btn btn--red btn--stroke btn--pill-stroke btn--pill-hr round">
            Confirm
          </button>
        </div>
        ...
        <div className="mb18 flex-parent-inline flex-parent--column">
          ...
          <button className="btn btn--orange btn--s btn--pill btn--pill-vc">
            Confirm
          </button>
          <button className="btn btn--orange btn--s btn--pill btn--pill-vc">
            Confirm
          </button>
          <button className="btn btn--orange btn--s btn--pill btn--pill-vb is-active">
            Confirm
          </button>
        </div>
        ...
        <div className="mb18 ml18 flex-parent-inline flex-parent--column">
          ...
          <button className="btn btn--stroke btn--s btn--pill-stroke btn--pill-vc round">
            Confirm
          </button>
          <button className="btn btn--stroke btn--s btn--pill-stroke btn--pill-vc round">
            Confirm
