      ...
      <Page>
        <div className='pt24'>
          ...
          <div className='mt60 flex-parent-mm'>
            <div className='flex-child flex-child--no-shrink mr24 mb0-mm mb18 w60 h60'><img src={baselineGridImg}/></div>
            <div>
          ...
          <div className='mt60 flex-parent-mm'>
            <div className='flex-child flex-child--no-shrink mr24 mb0-mm mb18 w60 h60'><img src={defaultsImg}/></div>
            <div>
              <h3 className='txt-bold'>
          ...
          <div className='mt60 flex-parent-mm'>
            <div className='flex-child flex-child--no-shrink mr24 mb0-mm mb18 w60 h60'><img src={boxModelImg}/></div>
            <div>
              <h3 className='txt-bold'>
          ...
          <div className='mt60 flex-parent-mm'>
            <div className='flex-child flex-child--no-shrink mr24 mb0-mm mb18 w60 h60'><img src={customIconsImg}/></div>
            <div>
              <h3 className='txt-bold'>
                Customizable icons
              </h3>
          ...
          <div className='mt60 flex-parent-mm'>
            <div className='flex-child flex-child--no-shrink mr24 mb0-mm mb18 w60 h60'><img src={mediaQueriesImg}/></div>
            <div>
              <h3 className='txt-bold'>
          ...
          <div className='mt60 flex-parent-mm'>
            <div className='flex-child flex-child--no-shrink mr24 mb0-mm mb18 w60 h60'><img src={modifierImg}/></div>
            <div>
              <h3 className='txt-bold'>
          ...
          <div className='mt60 flex-parent-mm'>
            <div className='flex-child flex-child--no-shrink mr24 mb0-mm mb18 w60 h60'><img src={specificityImg}/></div>
            <div>
              <h3 className='txt-bold'>
          ...
          <div className='mt60 flex-parent-mm'>
            <div className='flex-child flex-child--no-shrink mr24 mb0-mm mb18 w60 h60'><img src={isActiveImg}/></div>
            <div>
              <h3 className='txt-bold'>
          ...
          <div className='mt60 flex-parent-mm'>
            <div className='flex-child flex-child--no-shrink mr24 mb0-mm mb18 w60 h60'><img src={focusImg}/></div>
            <div>
              <h3 className='txt-bold'>
