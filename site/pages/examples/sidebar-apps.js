...
const basicSidebar = `<div class='flex-parent h-viewport-full relative overflow-hidden'>
  <div class='flex-child w-full w240-ml absolute static-ml left bottom'>
    <div class='flex-parent flex-parent--column h-viewport-1/3 h-full hmax-full bg-white'>
  ...
  <div class='flex-child flex-child--grow bg-darken10 h-h-viewport-2/3 h-viewport-full-ml'></div>
</div>`;
