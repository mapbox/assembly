<h1 class="txt-h2 txt-bold">Progress bars</h1>

<h2 class="border-b border-b--2 border--gray-faint pb6 mt60 mb24 txt-l txt-bold">Basic bar</h2>

```example
<div class='h12 bg-darken10 relative round-full'>
  <div class='absolute h12 bg-green-light round-full' style='width:50%;'></div>
</div>
```

<h2 class="border-b border-b--2 border--gray-faint pb6 mt60 mb24 txt-l txt-bold">Playback controls</h2>

```example
<div class='flex flex--row flex--center-cross border border--gray-light round-l'>
